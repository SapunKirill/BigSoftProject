 ...
 */
class Comments extends \Application\Entity\Comments implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'author_id', 'text', 'time', 'like', 'dislike');
        }
    ...
    public function setAuthorId($author_id)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAuthorId', array($author_id));
